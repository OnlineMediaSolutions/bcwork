...
func testNBSupplyHourliesExists(t *testing.T) {
	...
	e, err := NBSupplyHourlyExists(ctx, tx, o.Time, o.PublisherID, o.Domain, o.Os, o.Country, o.DeviceType, o.PlacementType, o.Size, o.RequestType, o.PaymentType)
	if err != nil {
...
func testNBSupplyHourliesFind(t *testing.T) {
	...
	nbSupplyHourlyFound, err := FindNBSupplyHourly(ctx, tx, o.Time, o.PublisherID, o.Domain, o.Os, o.Country, o.DeviceType, o.PlacementType, o.Size, o.RequestType, o.PaymentType)
	if err != nil {
		t.Error(err)
	}
