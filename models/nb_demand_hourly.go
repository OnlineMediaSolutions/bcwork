...
var (
	nbDemandHourlyAllColumns            = []string{"time", "demand_partner_id", "demand_partner_placement_id", "publisher_id", "domain", "os", "country", "device_type", "placement_type", "size", "request_type", "payment_type", "bid_requests", "bid_responses", "avg_bid_price", "dp_fee", "auction_wins", "auction", "sold_impressions", "revenue", "data_impressions", "data_fee"}
	nbDemandHourlyColumnsWithoutDefault = []string{"time", "demand_partner_id", "demand_partner_placement_id", "publisher_id"}
	nbDemandHourlyColumnsWithDefault    = []string{"domain", "os", "country", "device_type", "placement_type", "size", "request_type", "payment_type", "bid_requests", "bid_responses", "avg_bid_price", "dp_fee", "auction_wins", "auction", "sold_impressions", "revenue", "data_impressions", "data_fee"}
	nbDemandHourlyPrimaryKeyColumns     = []string{"time", "demand_partner_id", "demand_partner_placement_id", "publisher_id", "domain", "os", "country", "device_type", "placement_type", "size", "request_type", "payment_type"}
...
func FindNBDemandHourly(ctx context.Context, exec boil.ContextExecutor, time time.Time, demandPartnerID string, demandPartnerPlacementID string, publisherID string, domain string, os string, country string, deviceType string, placementType string, size string, requestType string, paymentType string, selectCols ...string) (*NBDemandHourly, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"nb_demand_hourly\" where \"time\"=$1 AND \"demand_partner_id\"=$2 AND \"demand_partner_placement_id\"=$3 AND \"publisher_id\"=$4 AND \"domain\"=$5 AND \"os\"=$6 AND \"country\"=$7 AND \"device_type\"=$8 AND \"placement_type\"=$9 AND \"size\"=$10 AND \"request_type\"=$11 AND \"payment_type\"=$12", sel,
	)

	q := queries.Raw(query, time, demandPartnerID, demandPartnerPlacementID, publisherID, domain, os, country, deviceType, placementType, size, requestType, paymentType)
...
func (o *NBDemandHourly) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(nbDemandHourlyAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(nbDemandHourlyPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert nb_demand_hourly, could not build conflict column list")
			}

			conflict = make([]string, len(nbDemandHourlyPrimaryKeyColumns))
			copy(conflict, nbDemandHourlyPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"nb_demand_hourly\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
func (o *NBDemandHourly) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"nb_demand_hourly\" WHERE \"time\"=$1 AND \"demand_partner_id\"=$2 AND \"demand_partner_placement_id\"=$3 AND \"publisher_id\"=$4 AND \"domain\"=$5 AND \"os\"=$6 AND \"country\"=$7 AND \"device_type\"=$8 AND \"placement_type\"=$9 AND \"size\"=$10 AND \"request_type\"=$11 AND \"payment_type\"=$12"
...
func (o *NBDemandHourly) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindNBDemandHourly(ctx, exec, o.Time, o.DemandPartnerID, o.DemandPartnerPlacementID, o.PublisherID, o.Domain, o.Os, o.Country, o.DeviceType, o.PlacementType, o.Size, o.RequestType, o.PaymentType)
	if err != nil {
		return err
	}
...
func NBDemandHourlyExists(ctx context.Context, exec boil.ContextExecutor, time time.Time, demandPartnerID string, demandPartnerPlacementID string, publisherID string, domain string, os string, country string, deviceType string, placementType string, size string, requestType string, paymentType string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"nb_demand_hourly\" where \"time\"=$1 AND \"demand_partner_id\"=$2 AND \"demand_partner_placement_id\"=$3 AND \"publisher_id\"=$4 AND \"domain\"=$5 AND \"os\"=$6 AND \"country\"=$7 AND \"device_type\"=$8 AND \"placement_type\"=$9 AND \"size\"=$10 AND \"request_type\"=$11 AND \"payment_type\"=$12 limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, time, demandPartnerID, demandPartnerPlacementID, publisherID, domain, os, country, deviceType, placementType, size, requestType, paymentType)
	}
	row := exec.QueryRowContext(ctx, sql, time, demandPartnerID, demandPartnerPlacementID, publisherID, domain, os, country, deviceType, placementType, size, requestType, paymentType)
...
func (o *NBDemandHourly) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return NBDemandHourlyExists(ctx, exec, o.Time, o.DemandPartnerID, o.DemandPartnerPlacementID, o.PublisherID, o.Domain, o.Os, o.Country, o.DeviceType, o.PlacementType, o.Size, o.RequestType, o.PaymentType)
}
