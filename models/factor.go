...
var (
	...
	factorColumnsWithoutDefault = []string{"publisher", "domain", "country", "device", "created_at", "rule_id", "browser", "os", "placement_type"}
	factorColumnsWithDefault    = []string{"factor", "updated_at", "demand_partner_id"}
