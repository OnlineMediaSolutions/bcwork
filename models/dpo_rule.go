...
var (
	dpoRuleAllColumns            = []string{"rule_id", "demand_partner_id", "publisher", "domain", "country", "browser", "os", "device_type", "placement_type", "factor", "created_at", "updated_at"}
	dpoRuleColumnsWithoutDefault = []string{"rule_id", "demand_partner_id", "created_at"}
	dpoRuleColumnsWithDefault    = []string{"publisher", "domain", "country", "browser", "os", "device_type", "placement_type", "factor", "updated_at"}
...
var dpoRuleAfterSelectMu sync.Mutex
var dpoRuleAfterSelectHooks []DpoRuleHook

var dpoRuleBeforeInsertMu sync.Mutex
var dpoRuleBeforeInsertHooks []DpoRuleHook
var dpoRuleAfterInsertMu sync.Mutex
var dpoRuleAfterInsertHooks []DpoRuleHook

var dpoRuleBeforeUpdateMu sync.Mutex
var dpoRuleBeforeUpdateHooks []DpoRuleHook
var dpoRuleAfterUpdateMu sync.Mutex
var dpoRuleAfterUpdateHooks []DpoRuleHook

var dpoRuleBeforeDeleteMu sync.Mutex
var dpoRuleBeforeDeleteHooks []DpoRuleHook
var dpoRuleAfterDeleteMu sync.Mutex
var dpoRuleAfterDeleteHooks []DpoRuleHook

var dpoRuleBeforeUpsertMu sync.Mutex
var dpoRuleBeforeUpsertHooks []DpoRuleHook
var dpoRuleAfterUpsertMu sync.Mutex
...
func (o *DpoRule) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(dpoRuleAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(dpoRulePrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert dpo_rule, could not build conflict column list")
			}

			conflict = make([]string, len(dpoRulePrimaryKeyColumns))
			copy(conflict, dpoRulePrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"dpo_rule\"", updateOnConflict, ret, update, conflict, insert, opts...)
