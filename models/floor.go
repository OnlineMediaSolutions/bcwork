...
func (floorL) LoadFloorPublisher(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFloor interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		args = append(args, object.Publisher)
	...
	Outer:
		for _, obj := range slice {
			...
			args = append(args, obj.Publisher)
...
func (o *Floor) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"floor\"", updateOnConflict, ret, update, conflict, insert)
